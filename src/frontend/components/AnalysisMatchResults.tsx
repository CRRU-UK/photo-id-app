...
import type {
  AnalysisMatchResult,
  AnalysisMatchResults as AnalysisMatchResultsData,
} from "@/types";
 ...
 */
const AnalysisMatchResults = () => {
  const { isAnalysing, result, error, inputLabel } = useAnalysis();
...
export default AnalysisMatchResults;
