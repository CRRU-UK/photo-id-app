...
- When closing the project view with the keyboard shortcut (CmdOrCtrl+W) or the sidebar close button, the window itself is closed (taking its edit windows with it)
